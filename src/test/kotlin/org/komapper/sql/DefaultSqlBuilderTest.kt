...
class DefaultSqlBuilderTest {
    ...
    fun simple() {
        ...
        val sql = DefaultSqlBuilder().build(template)
    ...
    class BindValueTest {
        ...
        fun singleValue() {
            ...
            val sql = DefaultSqlBuilder().build(template, mapOf("name" to ("aaa" to String::class)))
        ...
        fun multipleValues() {
            ...
            val sql = DefaultSqlBuilder().build(template, mapOf("name" to (listOf("x", "y", "z") to List::class)))
        ...
        fun multipleValues_empty() {
            val template = "select name, age from person where name in /*name*/('a', 'b') and age > 1"
            val sql = DefaultSqlBuilder().build(template, mapOf("name" to (emptyList<String>() to List::class)))
    ...
    class EmbeddedValueTest {
        ...
        fun test() {
            ...
            val sql = DefaultSqlBuilder().build(template, mapOf("orderBy" to ("order by name" to String::class)))
    ...
    class ForBlockTest {
        ...
        fun test() {
            ...
            val sql = DefaultSqlBuilder().build(template, mapOf("list" to (listOf(1, 2, 3) to List::class)))
